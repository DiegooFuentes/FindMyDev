...
<body body id="body-pd">
	<header class="header row" id="header">
		<div class="header_toggle col-md-2">
			<i class='bx bx-menu' id="header-toggle"></i>
		</div>
		<h2 class="text-buscador titulo_form  col-md-8">Mi Perfil</h2>

		<div class="dropdown col-1 ">
			<button class="dropdown-toggle boton_editar" type="button"
		...
		<div class="col-md-2 menu1">
			...
			<div class="d-flex menu_lista">
				...
				<div class="lista-item">
					<a href="/home/miperfil/habilidadesblandas"><button
							type="button" class="btn btn_menu" data-bs-dismiss="modal">Habilidades
							Blandas</button> </a>
				</div>
				<div class="lista-item">
					<a href="./RegistrosPostulante/habilidadestTecnicas.html"><button
							type="button" class="btn btn_menu" data-bs-dismiss="modal">Habilidades
							Tecnicas</button> </a>
				</div>
				<div class="lista-item">
					<a href="./RegistrosPostulante/laboral.html"><button
							type="button" class="btn btn_menu" data-bs-dismiss="modal">Experiencia
							Laboral</button></a>
				</div>
				<div class="lista-item">
					<a href="./RegistrosPostulante/academica.html"><button
							type="button" class="btn btn_menu" data-bs-dismiss="modal">Formación
							Académica</button></a>
				</div>
				<div class="lista-item">
					<a href="./RegistrosPostulante/registropostulanteproyecto.html"><button
							type="button" class="btn btn_menu" data-bs-dismiss="modal">Proyecto</button></a>
				</div>
				<div class="lista-item">
					<a href="./RegistrosPostulante/registropostulantedatocontacto.html"></a>
					<button type="button" class="btn btn_menu" data-bs-dismiss="modal">Datos
						de Contacto</button>
				</div>
			</div>
			<div></div>
