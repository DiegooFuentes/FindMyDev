...
<body body id="body-pd">
    <header class="header row" id="header">
        ...
        <h2 class="text-buscador titulo_form  col-md-8">Mis Datos Laboral</h2>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                                    ...
                                                    <div class="row justify-content">
                                                        ...
                                                        <div class="input-text">
                                                            ...
                                                            <input type="date" placeholder="Fecha de inicio - Término"
                                                                id="Fecha de inicio - Término" name="fechaInicio">

                                                        </div>
                                                        <div class="input-text">
                                                            <label for="fechaTermino">Fecha de Termino</label>
                                                            <input type="date" placeholder="Fecha de inicio - Término"
                                                                id="Fecha de inicio - Término" name="fechaTermino">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn btn_submit">Agregar</button>
                                            </div>
                        </form>
                    </div>
                </div>
 ...
 <div class="container-fluid menu-carta">
    <div class="row menu-form-inscritos">
      <div class="col-md-10 mx-auto contenedor-lab">
        <!--Inicio tarjeta-->
        <div class="card tarjeta-laboral">
            <h4 class="card-header tarLab-header">Featured</h4>
            <div class="card-body text-center">
              <h4 class="card-title tarLab-titulo ">Special title treatment</h4>
              <p class="card-text tarLab-text">With supporting text below as a natural lead-in to additional content.</p>
              <p class="card-text tarLab-text">Fecha Inicio : 2/03/2019</p>
              <p class="card-text tarLab-text">Fecha Termino: 5/08/2022</p>
            </div>
            <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                <button class="btn btn-primary me-md-2 btn-lab" type="button">Modificar</button>
                <button class="btn btn-primary  me-md-2 btn-lab" type="button">Eliminar</button>
              </div>
          </div>
        <!--Fin tarjeta-->
      </div>
