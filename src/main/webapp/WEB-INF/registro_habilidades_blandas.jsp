        ...
        <nav class="nav navbar-container">
            <div class="row header-nav " id="usuario">
                ...
                <div class="col-md-6 foto-avatar">
                    ...
                    <img class="imgg" href="" src="/assets/img/fotos/mujer.png" width="5px" alt="img-resposive">
    ...
    <div class="row contenedorMenu fondo">
        ...
        <div class="col-md-2 menu1">
            ...
            <img class="rounded-circle img1 text-center"
                src="/assets/img/fotos/4043251-avatar-female-girl-woman_113291.png" alt="img-resposive" />


            <div class="d-flex menu_lista">

                <div class="lista-item"> <a href="/home/miperfil/habilidadesblandas"><button type="button" class="btn btn_menu"
                            data-bs-dismiss="modal">Habilidades
                            Blandas</button> </a></div>
                <div class="lista-item"> <a href="/home/miperfil/habilidadesblandas"><button type="button"
                            class="btn btn_menu" data-bs-dismiss="modal">Habilidades
                            Tecnicas</button> </a></div>
                <div class="lista-item"><a href="./laboral.html"><button type="button" class="btn btn_menu"
                            data-bs-dismiss="modal">Experiencia Laboral</button></a></div>
                <div class="lista-item"><a href="./academica.html"><button type="button" class="btn btn_menu"
                            data-bs-dismiss="modal">Formación Académica</button></a></div>
                <div class="lista-item"><a href="./registropostulanteproyecto.html"><button type="button"
                            class="btn btn_menu" data-bs-dismiss="modal">Proyecto</button></a></div>
                <div class="lista-item"><a href="./registropostulantedatocontacto.html"><button type="button"
                            class="btn btn_menu" data-bs-dismiss="modal">Datos de Contacto</button></a></div>
            </div>
            <div>
            ...
            <div>
                ...
                <div class="row ">
                    ...
                    <div class="col-md-12 info_perfil">
                        ...
                        <form action="/home/miperfil/habilidadesblandas/formulario" method="post">
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <label>
                                                <input type="checkbox" id="cbox1" value="1" name="comunicacion">
                                                Comunicación</label>
                                            <br>                          
                                            <label>
                                                <input type="checkbox" id="cbox1" value="2" name="equipo">
                                                Trabajo en equipo</label>
                                            <br>
                                            <label>
                                                <input type="checkbox" id="cbox1" value="3" name="detalle">
                                                Orientación al detalle</label>
                                            <br>
                                            <label>
                                                <input type="checkbox" id="cbox1" value="4" name="tiempo">
